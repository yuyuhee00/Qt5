    ...
    , standardModel(new QStandardItemModel(this))
{
    ...
    // Changed by Song
    auto *song = new QStandardItem("Song");
    auto *seong = new QStandardItem("Seong");
    auto *young = new QStandardItem("Young");
    auto *juyoung = new QStandardItem("Ju Young");

//    young->appendRow(juyoung);
//    rootNode->appendRow(song);
//    rootNode->appendColumn({seong, young});
    song->appendRow(juyoung);
    rootNode->appendRow({song, seong, young});
    ...
    QObject::connect(selectionModel, &QItemSelectionModel::selectionChanged, this, &MainWindow::selectionChangedSlot);
}
...
void MainWindow::selectionChangedSlot(const QItemSelection & newSelection, const QItemSelection & oldSelection)
{
    ...
    this->setWindowTitle(showString);
}
